...
```{r}
ggplot(data = Cars93, aes(x= EngineSize, y= MPG.city))+ geom_point(color="blue", size = 2) + xlim(1,7) + ylim(10,40) + labs(title= "Scatterplot of EngineSize vs. MPG.city", subtitle = "Using Cars93 data set", x= "Engine Size", y = "City MPG", caption = "Data Source: Cars93 dataset")
```
...
```{r}
ggplot(data = Cars93, aes(x= EngineSize, y= MPG.city, color= Type))+ geom_point( size = 2) + xlim(1,7) + ylim(10,40) + labs(title= "Scatterplot of EngineSize vs. MPG.city", subtitle = "Using Cars93 data set", x= "Engine Size", y = "City MPG", caption = "Data Source: Cars93 dataset") + scale_color_brewer(palette = "Set1")
```
...
```{r}
ggplot(data = Cars93, aes(x= EngineSize, y= MPG.city, color= Type))+ geom_point( size = 2) + geom_smooth(method = "lm", se = FALSE, color = "red", linetype= "dashed") + xlim(1,7) + ylim(10,40) + labs(title= "Scatterplot of EngineSize vs. MPG.city", subtitle = "Using Cars93 data set", x= "Engine Size", y = "City MPG", caption = "Data Source: Cars93 dataset") + scale_color_brewer(palette = "Set1")

# you have fit a linear curve. Fit a smooth curve (-2)
```
...
```{r}
ggplot(data = Cars93, aes(x= AirBags, fill = AirBags)) + geom_bar()+ labs(title = "Count of Cars by AirBags", subtitle = "Using the Cars83 dataset", x = "AirBags", y = "Count", caption = "Data source: Cars93 dataset")
```
...
```{r}
ggplot(data = Cars93, aes(x= Origin, fill = AirBags)) + geom_bar(position = "dodge") + labs(title = "Count of Cars by AirBags and Origin", subtitle = "Using the Cars83 dataset", x = "Origin", y = "Count", caption = "Data source: Cars93 dataset")
```
...
```{r}
ggplot() + geom_sf(data = au_states, fill = "orange", color = "black") + labs(title = "Map of Australia")
```
...
```{r}
ggplot(data = au_states) + geom_sf(aes(fill = NAME)) + scale_fill_brewer(palette = "Set3") + labs(title = "Map of Australia")
```
## Task 3
...
```{r}
au_map <- ggplot(data = au_states) + geom_sf(aes(fill = NAME)) + scale_fill_brewer(palette = "Set3") + labs(title = "Map of Australia by State")
au_map + geom_point(data = au_capitals, aes(x = lon, y = lat), col = "red", size = 2)
```
...
```{r}
finals_map <- ggplot(data = au_states) + geom_sf(aes(fill = NAME)) + scale_fill_brewer(palette = "Set3") + labs(title = "Map of Australia by State")
finals_map + geom_point(data = au_capitals, aes(x = lon, y = lat), col = "red", size = 2) + coord_sf(crs = st_crs(3112))
