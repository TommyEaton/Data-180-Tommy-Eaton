...
Answer: Skewed to the left because most of the data is on the right and all of the smaller values are on the right. ## The data is approximately symmetric mean ~= median.(-1)
