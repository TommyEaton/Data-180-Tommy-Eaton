...
library(ggplot2)
library(cowplot)
graph1 <- ggplot(sorted_km_3, aes(x = factor(km_3), y = Water)) +
  geom_boxplot() +
  labs(title = "Water Content by Cluster", x = "Cluster", y = "Water Content")

graph2 <- ggplot(sorted_km_3, aes(x = factor(km_3), y = Protein)) +
  geom_boxplot() +
  labs(title = "Protein Content by Cluster", x = "Cluster", y = "Protein Content")

graph3 <- ggplot(sorted_km_3, aes(x = factor(km_3), y = Fat)) +
  geom_boxplot() +
  labs(title = "Fat Content by Cluster", x = "Cluster", y = "Fat Content")

graph4 <- ggplot(sorted_km_3, aes(x = factor(km_3), y = Lactose)) +
  geom_boxplot() +
  labs(title = "Lactose Content by Cluster", x = "Cluster", y = "Lactose Content")

graph5 <- ggplot(sorted_km_3, aes(x = factor(km_3), y = Ash)) +
  geom_boxplot() +
  labs(title = "Ash Content by Cluster", x = "Cluster", y = "Ash Content")
...
# How many clusters does the elbow plot suggest? How does this compare to your impression from the dendrogram in Question 2? (-2)
